package com.fit.vedads.appstore.design;
...
/**
 * Created by vedad on 11.1.2016.
 */
public class RoundedCorner extends ImageView {
    ...
    public RoundedCorner(Context context, AttributeSet attrs, int defStyle) {
